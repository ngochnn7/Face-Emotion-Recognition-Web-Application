    ...
    for k in range(150, 300, 50):
        for n_components in range(50, 150, 50):
            ...
            for train_index, val_index in kf.split(X_train_res, y_train_res):
                ...
                model = LogisticRegression(C=C, max_iter=1000, random_state=42, multi_class='multinomial')
...
model = LogisticRegression(C=best_params['C'], max_iter=1000, random_state=42, multi_class='multinomial')
